...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        while find_place is not beehive:
            if self.min_range <= dis <= self.max_range:
                if len(find_place.bees) > 0:
                    return rANTdom_else_none(find_place.bees) # REPLACE THIS LINE
    ...
    def reduce_armor(self, amount):
        ...
        for bee in bees:
            if self.armor > 0:
                ...
                Bee.reduce_armor(bee, self.damage + amount)
        # END Problem 5
...
# END Problem EC
    ...
    def __init__(self, armor=1):
        ...
        if not QueenAnt.queen_init:
            self.real_queen = True
            QueenAnt.queen_init += True
        # END Problem EC
    ...
    def action(self, gamestate):
        ...
        while find_place is not None:
            if find_place.ant is not None and not find_place.ant.damage_doubled:
                find_place.ant.damage *= 2
                find_place.ant.damage_doubled = True
...
class LaserAnt(ThrowerAnt):
    ...
    def insects_in_front(self, beehive):
        ...
        while insect_place is not beehive:
            if insect_place.ant is not None and insect_place.ant is not self:
                insects[insect_place.ant] = dis
            for bee in insect_place.bees:
                insects[bee] = dis
    ...
    def calculate_damage(self, distance):
        # BEGIN Problem Optional 5
        weaken_damage = 0.2 * distance + self.insects_shot * 0.05
        return max(2 - weaken_damage, 0)
        # END Problem Optional 5
